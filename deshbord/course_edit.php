...
if (isset($_REQUEST['btn_edit'])) {
    ...
    $path1 = "../wp-contents/uploads/courses/" . $newname1;
    ...
    if ($cs_img_enc) {
        ...
        $newname1 = $cs_img_edit;
    }

    // บันทึกข้อมูล
    if (!isset($errorMsg)) {
        $sql = "UPDATE tbl_course_db SET 
        cs_code = '$cs_code',
        cs_name = '$cs_name',
        cs_des = '$cs_des',
        cs_objective = '$cs_objective',
...
?>
    ...
    <head>
        <!-- Meta -->
        <meta charset="UTF-8">
        <title>ฟอร์มแก้ไขรายวิชา &#8211; แหล่งเรียนรู้สาขาเทคโนโลยีธุรกิจดิจิทัล วิทยาลัยเทคโนโลยีพณิชยการหาดใหญ่</title>
                    ...
                    <div class="container">
                        ...
                        <div class="wp-content-desh-container">
                            ...
                            <div class="mb-3 wp-content-desh-title">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <strong>ฟอร์มแก้ไขรายวิชา</strong>
                                </div>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="cs_code" class="form-control" id="cs_code" value="<?php echo $data['cs_code']; ?>" placeholder="(Ex. 30204-2007)" autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="cs_name" class="form-label">รายวิชาชื่อ <span class="sp-red">*</span></label>
                                                                <input type="text" name="cs_name" class="form-control" id="cs_name" value="<?php echo $data['cs_name']; ?>" placeholder="(Ex. เครือข่ายคอมพิวเตอร์)" autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                                            <div class="mb-1">
                                                                <label for="cs_des" class="form-label">คำอธิบายรายวิชาสั้น ๆ <span class="sp-red">*</span> (จำกัดข้อความ 100 ตัวอักษร)</label>
                                                                <textarea name="cs_des" class="form-control" id="cs_des" rows="3" placeholder="(Ex. ศึกษาและปฏิบัติเกี่ยวกับหลักการเครือข่ายคอมพิวเตอร์ ความสำคัญ ประเภทและรูปแบบของระบบเครือข่าย)"><?php echo $data['cs_des']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-lg-6 mx-auto">
                                                                    <div class="d-grid">
                                                                        <input type="hidden" name="cs_img_edit" value="<?php echo $data['cs_img']; ?>">
