...
if (isset($_REQUEST['btn_delete'])) {
    ...
    $at_img_delete = $_POST["at_img_delete"];

    $at_url = $_POST["at_url"];
    $directory = "../wp-contents/uploads/articles/";

    // ลบข้อมูลจากโฟลเดอร์
    unlink($directory . $at_img_delete);

    // ลบข้อมูลในฐานข้อมูล
    $sql = "DELETE FROM tbl_article_db WHERE at_url = '$at_url'";
...
?>
    <!DOCTYPE html>
    <html lang="th" system-icons="" typography="" typography-spacing="" standardized-themed-scrollbar="">

    <head>
        <!-- Meta -->
        <meta charset="UTF-8">
        <title>จัดการบทความ &#8211; แหล่งเรียนรู้สาขาเทคโนโลยีธุรกิจดิจิทัล วิทยาลัยเทคโนโลยีพณิชยการหาดใหญ่</title>
                    ...
                    <div class="container">
                        ...
                        <div class="wp-content-desh-container">
                            ...
                            <div class="mb-3 wp-content-desh-title">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="mb-3">
                                        <strong>ตารางฐานข้อมูลบทความ</strong>
                                    </div>
                                </div><?php
                                    ...
                                    <form action="" method="POST">
                                        <div class="row d-flex">
                                            <div class="col-sm-12 col-md-6 mb-2 mb-md-0">
                                                <input type="search" class="form-control form-control-sm" name="search_query" value="<?php echo isset($search) ? $search : '' ?>" placeholder="บทความเรื่อง, หมวดหมู่" autocomplete="off" required>
                                            </div>
                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                <div class="d-grid">
                                                    <a href="<?php echo $server['sv_url']; ?>/deshbord/articles" class="btn btn-sm btn-warning">กลับไป</a>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-3 col-lg-3">
                                                <div class="d-grid">
                                    ...
                                    <form action="" method="POST">
                                        <div class="row d-flex">
                                            <div class="col-sm-12 col-md-3 col-lg-2 mb-2 mb-md-0">
                                                <div class="d-grid">
                                                    <a href="<?php echo $server['sv_url']; ?>/deshbord/article_insert" class="btn btn-sm btn-success">+ เพิ่ม</a>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-3 col-lg-2 mb-2 mb-md-0">
                                                <div class="d-grid">
                                                    <a href="<?php echo $server['sv_url']; ?>/deshbord/illustration" class="btn btn-sm btn-info">ภาพประกอบ</a>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody><?php while ($row = mysqli_fetch_assoc($result_data)) { ?>
                                                        ...
                                                        <tr valign="middle" class="text-nowrap">
                                                            ...
                                                            <!-- <td style="width: 15rem;"><?php echo $row['at_url']; ?></td> -->
                                                            <td style="width: 30rem;"><?php echo $row['at_title']; ?></td>
                                                            <td style="width: 20rem;"><?php echo $row['cg_name']; ?></td>
                                                            <td style="width: 20rem;"><?php echo $row['at_time_add']; ?></td>
                                                            <!-- <td style="width: 20rem;"><?php echo $row['at_time_edit']; ?></td> -->
                                                            <td style="width: 10rem;">
                                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#PREVIEW<?php echo $row['at_url']; ?>" class="btn btn-sm btn-success">ดูตัวอย่าง</button>
                                                                    <a href="<?php echo $server['sv_url']; ?>/deshbord/article_edit?url=<?php echo $row['at_url']; ?>" class="btn btn-sm btn-warning">แก้ไข</a>
                                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#DELETE<?php echo $row['at_url']; ?>" class="btn btn-sm btn-danger">ลบ</button>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <form action="" method="post">
                                                            <input type="hidden" name="at_url" value="<?php echo $row['at_url']; ?>">
                                                            <div class="modal fade" id="PREVIEW<?php echo $row['at_url']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-xl">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="PREVIEW<?php echo $row['at_url']; ?>">ดูภาพตัวอย่าง</h5>
                                                        ...
                                                        <form action="" method="post">
                                                            <input type="hidden" name="at_url" value="<?php echo $row['at_url']; ?>">
                                                            <input type="hidden" name="at_img_delete" value="<?php echo $row['at_img']; ?>">
                                                            <div class="modal fade" id="DELETE<?php echo $row['at_url']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-md">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="DELETE<?php echo $row['at_url']; ?>">ลบข้อมูล</h5>
                                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <div class="row">
